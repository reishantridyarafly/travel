...
@section('content')
    <div class="container-fluid">
        <div class="layout-specing">
            ...
            <a href="{{ route('customers.index') }}" class="btn btn-warning btn-sm mt-4"><i
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Username" name="username" value="{{ $customer->username }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="number"
                                                    class="form-control ps-5 @error('no_hp') is-invalid @enderror"
                                                    placeholder="Telepon" name="no_hp" value="{{ $customer->no_hp }}"
