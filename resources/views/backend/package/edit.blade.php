            ...
            <div class="d-md-flex justify-content-between align-items-center">
                ...
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                        <li class="breadcrumb-item text-capitalize"><a href="{{ route('customers.index') }}">Pelanggan</a>
                        </li>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                placeholder="Nama Paket" name="name" value="{{ $package->name }}"
                                                autocomplete="name">
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Contoh: Bandung atau Bandung - Jakarta" name="location"
                                                value="{{ $package->location }}" autocomplete="location">
                                            @error('location')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('price') is-invalid @enderror"
                                                ...
                                                value="{{ $package->price }}" autocomplete="price">
                                            @error('price')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="benefits"
                                                value="{{ implode(',', $package->benefits->pluck('name')->toArray()) }}"
                                                data-role="tagsinput" autocomplete="benefits">
                                            @error('benefits')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="row">
                                                <div class="col-7 col-sm-10 mb-2">
                                                    <input name="duration" id="duration" type="number"
                                                        ...
                                                        placeholder="Durasi" value="{{ $package->duration }}">
                                                    @error('duration')
                                            ...
                                            <div class="row">
                                                <div class="col-7 col-sm-10 mb-2">
                                                    <input name="kapasitas" id="kapasitas" type="number"
                                                        ...
                                                        placeholder="Kapasitas" value="{{ $package->kapasitas }}">
                                                    @error('kapasitas')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="summernote" rows="4"
                                                class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi">{{ $package->description }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
