                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            ...
                            @foreach ($package->images as $image)
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="{{ $activeIndex }}" @if($activeIndex === 0) class="active" aria-current="true" @endif aria-label="Slide {{ $activeIndex + 1 }}"></button>
                        ...
                        <div class="carousel-inner">
                            ...
                            @foreach ($package->images as $image)
                                <div class="carousel-item @if($activeIndex === 0) active @endif">
                                    <img src="{{ asset('storage/packages/' . $image->path) }}" class="d-block w-100" alt="image">
                                </div>
                                @php $activeIndex++; @endphp
                            @endforeach
                        </div>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <ul class="list-unstyled mt-3">
                                <li class="list-inline-item text-muted me-2"><i class="uil uil-map-marker me-1"></i>{{ $package->location }}</li>
                                <li class="list-inline-item text-muted"><i class="uil uil-calender me-1"></i>Durasi {{ $package->duration }} Hari</li>
                            </ul>
                        </div>
