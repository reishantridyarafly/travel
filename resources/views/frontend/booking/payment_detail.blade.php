                    ...
                    <div class="card shadow rounded border-0">
                        ...
                        <div class="card-body">
                            <div class="custom-form">
                                <form action="{{ route('payment_detail.save', $transaction->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="card shadow">
                                                <div class="card-body">
                                                    <p>Setelah pembayaran Anda konfirmasi dengan mengirimkan bukti
                                                        pembayaran, kami akan validasi pembayaran anda.</p>
                                                    <label class="form-label">Upload Bukti Pembayaran <span
                                                            class="text-danger">*</span></label>
                                                    <input name="photo_evidence" id="photo_evidence" type="file"
                                                        class="form-control @error('photo_evidence') is-invalid @enderror">
                                                    <small class="text-muted">Ukuran file tidak boleh lebih dari
                                                        2MB.</small>
                                ...
                                <div class="row">
                                    <div class="col-12 ">
                                        <form action="{{ route('payment_detail.cancel', $transaction->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="d-grid">
                            ...
                            <div class="custom-form">
                                <div class="row mb-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <span class="fw-bold">Rp
                                            {{ number_format($booking->package->price, 0, ',', '.') }}</span>
                                    </div>
                                </div>
                            </div>
                            <!--end custom-form-->
