                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-icon position-relative">
                                        <input name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Kata sandi baru :">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-icon position-relative">
                                        <input name="password_confirmation" type="password" class="form-control" placeholder="Konfirmasi kata sandi :">
                                    </div>
                                </div>
                            </div><!--end col-->
